...
- **Economy foundation**: household records, building-centric daily economy, freight jobs, `OWA` fallback, exact entrance-side freight ETA, unemployment benefit disbursement, two-day building bankruptcy, and short private-building construction timers are all live. See [`economy.md`](economy.md).
