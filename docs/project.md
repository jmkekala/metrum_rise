...
- **Unit tests** (`simulation/economy/agents/tests.rs`): `test_agent_fsm_planned_departure_lifecycle` verifies that economy-planned departures leave `TRANSIT_IDLE` and enter the live road/pathing FSM correctly.
