...
use crate::config::{ZONING_DEPTH, HEIGHT_SCALE};

impl SimulationNode {
    /// Projects a world position onto a road edge.
    pub fn get_projection_data(&self, edge: &crate::simulation::network::graph::Edge, p: godot::prelude::Vector2) -> interaction::ProjectionData {
    ...
    pub fn get_obstacle_polygons_internal(&self, _ignore_poly_id: i32, ignore_edge_idx: i32) -> PackedFloat32Array {
    ...
    pub fn get_max_polygon_depth_internal(&self, origin_x: f32, origin_z: f32, dir_x: f32, dir_z: f32, max_search: f32) -> f32 {
    ...
    pub fn intersect_terrain_internal(&self, ray_origin: Vector3, ray_dir: Vector3) -> Option<Vector3> {
