...
fn flat_junctionn_canonical_raw_polygon_golden_checks_cover_generated_matrix() {
    assert_canonical_node_raw_polygon_golden(
        ...
        CanonicalNodeRawPolygonGolden {
            ...
            top_polygon_count: 163,
            carrier_record_count: 235,
            source_segment_record_count: 21,
            polygon_key_set_digest: 8195966459733576277,
            top_owner_height_field_digest: 18243076601615270593,
            carrier_owner_source_height_field_digest: 597954473172190879,
            source_segment_id_digest: 6915118323044878932,
            source_segment_ids: vec![
                ...
                "NodeSourceCarrierSegmentId { owner: NodeBandOwner { kind: Carriageway, owner_index: 15 }, source_kind: Carriageway, source_mouth_order_index: 2, source_band_index: 3, segment_start: NodeOwnedRegionArrangementKey { x_key: -3500000, z_key: -1 }, segment_end: NodeOwnedRegionArrangementKey { x_key: -3432749, z_key: -682816 } }".to_owned(),
    ...
    assert_canonical_node_raw_polygon_golden(
        ...
        CanonicalNodeRawPolygonGolden {
            kind: RoadSurfaceVisualNodePieceKind::JunctionN,
            top_polygon_count: 350,
            carrier_record_count: 450,
            source_segment_record_count: 25,
            polygon_key_set_digest: 9536921935364233591,
            top_owner_height_field_digest: 4821319241389759959,
            carrier_owner_source_height_field_digest: 145353550435259063,
            source_segment_id_digest: 13957710640833005785,
            source_segment_ids: vec![
    ...
    assert_canonical_node_raw_polygon_golden(
        ...
        CanonicalNodeRawPolygonGolden {
            kind: RoadSurfaceVisualNodePieceKind::JunctionN,
            top_polygon_count: 524,
            carrier_record_count: 667,
            source_segment_record_count: 29,
            polygon_key_set_digest: 9684430236143847545,
            top_owner_height_field_digest: 10144779158906647784,
            carrier_owner_source_height_field_digest: 4196066366939270159,
