...
//           and lane types at this level so consumers use graph::Edge
//           rather than reaching into the data or lane_spec files, which
//           leaves the internal split between data, rebuild, and spatial
//           free to change.
//  kind: module
//  spec: none
