...
//           merging nodes, and removing them. Covers shallow and extreme
//           crossing angles alongside the clean 4-way, and pins the
//           refusal to merge two edges whose vehicle frontage access
//           disagrees, since merging them would silently change which side
//           buildings may address.
//  kind: test
//  spec: none
