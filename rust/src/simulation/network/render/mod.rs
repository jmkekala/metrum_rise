...
pub struct NetworkMeshData {
    ...
    // Source ranges extend the existing chunk cache; previews can replace owners without
    // clipping triangles heuristically or rebuilding unrelated roads in the same chunk.
