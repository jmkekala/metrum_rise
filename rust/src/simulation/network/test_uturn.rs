...
//           they are forbidden. A two-way junction with exactly two
//           incident edges is the case that matters: a naive all-pairs
//           connection build pairs each inbound lane with the outbound
//           lane of the same edge and produces a legal-looking reversal.
//  kind: test
//  spec: none
