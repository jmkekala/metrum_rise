...
//           and query. Drives real RegionGraph, RoadSurfaceSystem, and
//           TerrainSystem instances rather than stubs, because site
//           frontage, the flat support footprint, and the grading target
//           height are all read off actual road surface samples; a mocked
//           surface would pass while the shipped geometry floated.
//  kind: test
//  spec: none
