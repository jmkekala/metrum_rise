...
//  MANIFEST
// ========================================================================
//  script_name: junction.rs
//  script_path: rust/src/simulation/economy/agents/tick/movement/network/junction.rs
//  module_name: junction
//  version: 0.1.0
//  description: Junction lane-end orchestration for network movement.
//  kind: module
//  spec: none
