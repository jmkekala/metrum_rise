...
use super::super::super::{ACCESS_PLAN_VALID, MODE_CAR, TRANSIT_IN_BUILDING, TRANSIT_NETWORK};
...
use super::super::planning::plan_network_replan;
use super::super::slices::MovementSlices;
use super::super::traffic::lane_attach_slot_clear;
use super::{BUILDING_REPLAN_DELAY_S, NETWORK_REPLAN_DELAY_S, transit_mode_label};
...
pub(super) unsafe fn handle_access_egress(
    i: usize,
    delta: f32,
    sim_time: f32,
...
/// Safety: `i` must be unique to the current worker for every raw slice in `slices`.
#[allow(clippy::too_many_arguments)]
pub(super) unsafe fn handle_access_ingress(
    i: usize,
    delta: f32,
    sim_time: f32,
    allocator: &BuildingAllocator,
