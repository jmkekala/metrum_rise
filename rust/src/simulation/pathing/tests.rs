...
//           mode-specific access, and turn restrictions. The CCH cases
//           build a loop with a restricted turn and check both the direct
//           route without the restriction and the detour with it, because
//           a shortcut that was contracted before the restriction was
//           applied will still return the forbidden path.
//  kind: test
//  spec: none
